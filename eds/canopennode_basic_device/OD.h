...
********************************************************************************
    ...
    File info:
        ...
        Project File: canopennode_basic_device.xdd
        File Version: 1

        Created:      2020/11/28 19:37:54
        Created By:   Janez Paternoster
        Modified:     2021/3/16 2:31:59
...
#ifndef OD_ATTR_PERSIST_TEST
#define OD_ATTR_PERSIST_TEST
#endif
extern OD_ATTR_PERSIST_TEST OD_PERSIST_TEST_t OD_PERSIST_TEST;
...
#define OD_ENTRY_H2111_variableInt32Save &OD->list[37]
#define OD_ENTRY_H2112_variableNV_Int32AutoSave &OD->list[38]
#define OD_ENTRY_H2120_testingVariables &OD->list[39]
#define OD_ENTRY_H6000_readDigitalInput8_bit &OD->list[40]
#define OD_ENTRY_H6200_writeDigitalOutput8_bit &OD->list[41]
#define OD_ENTRY_H6401_readAnalogInput16_bit &OD->list[42]
#define OD_ENTRY_H6411_writeAnalogOutput16_bit &OD->list[43]
